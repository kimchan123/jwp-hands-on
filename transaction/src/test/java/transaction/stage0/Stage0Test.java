...
/**
 * ACID 기본 원칙이 무엇인지 학습해보자. 그리고 answer 변수에 트랜잭션의 특성을 영어 단어로 작성해서 테스트를 통과시켜보자. 예) final var answer = "database";
 * <p>
 * ACID https://en.wikipedia.org/wiki/ACID
 * <p>
 * Database Basics: ACID Transactions https://towardsdatascience.com/database-basics-acid-transactions-bf4d38bd8e26
 */
class Stage0Test {
